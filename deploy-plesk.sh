...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║                                                              ║${NC}"
echo -e "${BLUE}║        NEXUS COS - PLESK DEPLOYMENT SCRIPT                   ║${NC}"
echo -e "${BLUE}║        Production + Beta Domain Setup                        ║${NC}"
echo -e "${BLUE}║                                                              ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ ! -f "/usr/local/psa/version" ]; then
    echo -e "${RED}✗ Plesk not detected. This script requires Plesk.${NC}"
    echo "For standard deployments, use deploy-nexus-cos-master.sh"
    exit 1
fi
PLESK_VERSION=$(cat /usr/local/psa/version)
echo -e "${GREEN}✓ Plesk detected: $PLESK_VERSION${NC}"
...
echo -e "${GREEN}✓ Beta vhost configured${NC}"
