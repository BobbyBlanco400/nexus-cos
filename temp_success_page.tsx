    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black flex items-center justify-center p-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/">
            <button className="px-6 py-3 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-semibold hover:opacity-90 transition-opacity">
              Return to Home
            </button>
          </Link>
          <Link href="/dashboard">
            <button className="px-6 py-3 rounded-lg bg-gradient-to-r from-green-400 to-emerald-500 text-white font-semibold hover:opacity-90 transition-opacity">
              Go to Dashboard
            </button>
          </Link>
        </div>
