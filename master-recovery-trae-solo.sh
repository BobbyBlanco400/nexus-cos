...
print_header() {
    ...
    echo -e "${CYAN}VPS: 74.208.155.161 | Domains: nexuscos.online, beta.nexuscos.online${NC}"
...
3. Test SSL: `openssl s_client -connect nexuscos.online:443`
