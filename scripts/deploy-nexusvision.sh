...
echo "   AR Demo: https://nexuscos.online/nexusvision/experiences/ar-demo.html"
echo "   VR Demo: https://nexuscos.online/nexusvision/experiences/vr-demo.html"
echo "   Config:  https://nexuscos.online/nexusvision/nexusvision-config.json"
echo ""
echo -e "${BLUE}================================================${NC}"
