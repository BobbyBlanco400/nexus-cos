...
echo "   3D Viewer: https://nexuscos.online/holocore/viewer.html"
echo "   AR Experience: https://nexuscos.online/holocore/ar-experience.html"
echo "   Config: https://nexuscos.online/holocore/holocore-config.json"
echo ""
echo -e "${PURPLE}================================================${NC}"
